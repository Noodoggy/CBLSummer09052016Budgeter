...
namespace CBLSummer09052016Budgeter.Controllers
{
    ...
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            var cat = budgetItem.Budget.Household.Account.NotVoid().SelectMany(t => t.Transaction.Where(c => c.CategoryId == budgetItem.CategoryId)); 
            ViewBag.currentBalance = (from a in cat
                                        select a.Amount)
                                        .Sum();
